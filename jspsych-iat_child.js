...
var category_block = {
  ...
  '<strong>子ども</strong>:<br>' + 
  '若い、幼い、未成熟な、小さい<br><br>',
  post_trial_gap: 1500
};
...
//5.本番試行の教示文(悪い + 子ども / 良い)
var instructions_block2 = {
  type: 'html-keyboard-response',
  stimulus: 
  "<div style='position: absolute; top: 18%; left: 20%'>eキーを押す:<br> " +
  "<strong>悪い</strong><br>" + "または<br>" + "<strong>子ども</strong></div>" + 
  ...
  "悪いカテゴリー/子どもカテゴリーの項目が表示されたら<strong>eキー</strong>を、<br>" +
  ...
  timeline: [
    {
      ...
      left_category_key: 'e',
      right_category_key: 'i',
      left_category_label: ['悪い', '子ども'],
      right_category_label: ['良い', '　　'],
      response_ends_trial: true,
      data: { iat_type: '悪い-子どもL' }
    }
  ],

  //IATで使う刺激
  timeline_variables: [
    {type: 'iat-html', stimulus: "若い", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "幼い", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "未成熟な", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "小さい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "嫌悪感のある", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "見苦しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "卑しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "汚らしい", stim_key_association: "left"},
...
var instructions_block3 = {
  ...
  "<div style='position: absolute; top: 18%; right: 20%'>iキーを押す:<br>" +
  "<strong>良い</strong><br>" + "または<br>" + "<strong>子ども</strong></div>" +
  "<div style='position: relative; top: 42%; margin-left: auto; margin-right: auto'><br><br><br><br><br><p>"+
  "悪いカテゴリーの項目が表示されたら<strong>eキー</strong>を<br>" +
  "良いカテゴリー/子どもカテゴリーの項目が表示されたら<strong>iキー</strong>を押してください。<br>" +
  "どの項目も、ひとつのカテゴリーにのみ属しています。</p><p>" +
  "分類を間違えた場合、赤色でXマークが表示されます。正しいキーを押し直して、課題を続行してください。<br>" +
  "できるだけ素早く、正確に回答してください。</p><p>" +
  "準備ができたら、いずれかのキーを押して開始してください。</p></div>",
  ...
  timeline: [
    {
      ...
      right_category_key: 'i',
      left_category_label: ['悪い', '　　'],
      right_category_label: ['良い', '子ども'],
      response_ends_trial: true,
      data: { iat_type: '良い-子どもR' }
    }
  ],
...
var instructions_block4 = {
  ...
  "<strong>悪い</strong><br>" + "　　　<br>" + "<strong>　　　</strong></div>" +
  "<div style='position: relative; top: 42%; margin-left: auto; margin-right: auto'><br><br><br><br><br><p>"+
  "良いカテゴリー/子どもカテゴリーの項目が表示されたら<strong>eキー</strong>を<br>" +
  ...
  timeline: [
    {
      ...
      left_category_key: 'e',
      right_category_key: 'i',
      left_category_label: ['良い', '子ども'],
      right_category_label: ['悪い', '　　'],
      response_ends_trial: true,
      data: { iat_type: '良い-子どもL' }
    }
  ],
...
var instructions_block5 = {
  ...
  "悪いカテゴリー/子どもカテゴリーの項目が表示されたら<strong>iキー</strong>を押してください。<br>" +
  "どの項目も、ひとつのカテゴリーにのみ属しています。</p><p>" +
  "分類を間違えた場合、赤色でXマークが表示されます。正しいキーを押し直して、課題を続行してください。<br>" +
  "できるだけ素早く、正確に回答してください。</p><p>" +
  "準備ができたら、いずれかのキーを押して開始してください。</p><p></div>",
  ...
  timeline: [
    {
      ...
      right_category_label: ['悪い', '子ども'],
      response_ends_trial: true,
      data: { iat_type: '悪い-子どもR' }
    }
  ],
